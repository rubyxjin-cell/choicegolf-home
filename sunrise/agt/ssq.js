...
(function(){
  ...
  /* 견적서 하단 = 썬앤스카이 명함 느낌 (사장님 지시 2026-09-09: 초이스골프 푸터 폐기 → SUN & SKY 로고 + 최진우 회원예약실 팀장 + 회사 정보) */
  var CO = { name:'㈜썬앤스카이골프코리아', mgr:'최진우', dept:'회원예약실', pos:'팀장', mobile:'010-5897-1053', tel:'1533-3160',
  ...
  function render(q, mode){
    ...
    var tidy = function(x){
      return String(x).replace(/\s*\(현지 지불\)/g, '')
        .replace(/^(호텔 )?숙박(\s*\(.*\))?$/, '호텔 숙박')   /* 카드 표기라 줄여 쓸 필요 없음 — '호텔 숙박'·'무제한 그린피'로 (사장님 2026-09-18) */

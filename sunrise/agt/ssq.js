...
(function(){
  ...
  function render(q, mode){
    ...
    var infoRows = ''
      ...
      + '<div class="qi full"><span class="k">포함사항</span><span class="v wrap">' + (inc.length ? inc.map(cpt).join(' / ') : '-') + '</span></div>'
      + '<div class="qi full"><span class="k">불포함사항</span><span class="v wrap">' + (exc.length ? exc.map(cpt).join(' / ') : '-') + '</span></div>'
      + (function(){

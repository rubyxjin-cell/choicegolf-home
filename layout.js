...
(function() {
  ...
  @import url('https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@400;500;600;700&family=Gaegu:wght@300;400;700&family=Noto+Serif+KR:wght@400;500;600;700&family=Gowun+Dodum&family=Gothic+A1:wght@500;700;800&display=swap');
  ...
  @media (max-width: 1100px) {
    ...
    .cg-gnb-logo img { height: 44px !important; }
      ...
      <header class="cg-header cg-layout-scope cg-nopromo">
        <div class="cg-header-inner">
          <a href="index.html" class="cg-logo">
            <img src="images/CHC%20LOGO.png?v=20260725f" alt="초이스골프" class="cg-logo-img">
          </a>
          <div class="cg-right">
  ...
  // ========== 🆕 GNB 고정 감지: 붙으면 로고 표시 ==========
  function initGnbLogo() {
    const gnb = document.querySelector('.cg-gnb');
    if (!gnb) return;
    const onScroll = () => {
      if (gnb.getBoundingClientRect().top <= 0 && window.scrollY > 60) gnb.classList.add('cg-stuck');
      else gnb.classList.remove('cg-stuck');
    };
    ...
    return `
      <nav class="cg-gnb cg-layout-scope">
        <div class="cg-gnb-inner">
          <a href="index.html" class="cg-gnb-logo"><img src="images/CHC%20LOGO.png?v=20260725f" alt="초이스골프"></a>

      ...
      <header class="cg-header cg-layout-scope cg-nopromo">
        <div class="cg-header-inner">
          <a href="index.html" class="cg-logo">
            <img src="images/logo-h.png?v=20260725g" alt="초이스골프" class="cg-logo-img">
          </a>
          <div class="cg-right">
    ...
    return `
      <nav class="cg-gnb cg-layout-scope">
        <div class="cg-gnb-inner">
          <a href="index.html" class="cg-gnb-logo"><img src="images/logo-h.png?v=20260725g" alt="초이스골프"></a>

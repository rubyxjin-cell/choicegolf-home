...
응답 형식 (마크다운 코드블록 X, 순수 JSON만):
{
  ...
  "tagline": "10~20자 짧은 한 줄 강조 카피 (예: '미야코지마 5성급 럭셔리 해변 호텔')"`;
      ...
      systemPrompt += `
  "holes": 골프장 홀수 (보통 18 또는 36, 정확히 확인된 경우만, 못 찾으면 null),
  "par": 파 (보통 72, 정확히 확인된 경우만, 못 찾으면 null),
  "yards": 총 야드 (정확한 숫자만, 못 찾으면 null)`;
    }

    systemPrompt += `
}

★ 절대 추측 금지! 웹검색으로 확인된 정보만 입력. 못 찾으면 null로 표시.
